!function (t, e) {
    ...
    (a = t.prototype).axisX = function (t, e, i) {
        ...
        var e = this, i = e.tickFormat ? e.tickFormat(t) : t;
        return void 0 !== i ? i : ""
        ...
        return t.select("text").text(function (t) {
            ...
            var n = this.getBoundingClientRect(), a = e.textFormatted(t), r = n.height,
        ...
        function n(t, e) {
            r = void 0;
            for (var i = 1; i < e.length; i++) if (" " === e.charAt(i) && (r = i), a = e.substr(0, i + 1), o = s.tickTextCharSize.w * a.length, d < o) return n(t.concat(e.substr(0, r || i)), e.slice(r ? r + 1 : i));
            return t.concat(e)
        }

        var a, r, o, s = this, c = s.textFormatted(t), d = s.params.tickWidth, l = [];
        ...
        function t(a) {
            a.each(function () {
                var a, r, o, s = t.g = i.select(this), c = this.__chart__ || e.scale,
                    d = this.__chart__ = e.copyScale(), l = e.tickValues ? e.tickValues : e.generateTicks(d),
                    u = s.selectAll(".tick").data(l, d),
                    h = u.enter().insert("g", ".domain").attr("class", "tick").style("opacity", 1e-6),
                    g = u.exit().remove(), f = e.transitionise(u).style("opacity", 1);
                ...
                var p = f.select("line"), _ = f.select("text"),
    ...
    (n = A.prototype).init = function () {
        ...
        return e.axis_x_tick_format && (u(e.axis_x_tick_format) ? i = e.axis_x_tick_format : t.isTimeSeries() && (i = function (i) {
        ...
        var e = this.owner, i = e.main.select("." + r.axisX + " ." + r.axisXLabel),
        ...
        if (e) if (1 === (n = u(e) ? e() : e)) l = [t[0]]; else if (2 === n) l = [t[0], t[t.length - 1]]; else if (n > 2) {
            for (o = n - 2, a = t[0], s = ((r = t[t.length - 1]) - a) / (o + 1), l = [a], c = 0; c < o; c++) d = +a + s * (c + 1), l.push(i ? new Date(d) : d);
            l.push(r)
        }
    ...
    var P, C, L = {version: "0.4.18"};
    return L.generate = function (t) {
        return new e(t)
    }, L.chart = {
        fn: e.prototype,
        internal: {fn: i.prototype}
    }, P = L.chart.fn, C = L.chart.internal.fn, C.beforeInit = function () {
        ...
        var e, i, n = this, a = n.d3, o = n.config, s = !0;
        ...
        "grid" === e && t.each(function () {
            ...
            t.attr({x1: Math.ceil(e), x2: Math.ceil(n), y1: Math.ceil(a), y2: Math.ceil(r)})
        })
    }, C.updateSizes = function () {
        var t = this, e = t.config, i = t.legend ? t.getLegendHeight() : 0, n = t.legend ? t.getLegendWidth() : 0,
            a = t.isLegendRight || t.isLegendInset ? 0 : i, r = t.hasArcType(),
        ...
        var i, n, a, o, s, c, d, l, u, h, g, f, p, _, x, m, y, S, v, b, T, A, P, C, L, V, G, E, O, I = this, R = I.main,
            k = I.d3, D = I.config, F = I.getShapeIndices(I.isAreaType), X = I.getShapeIndices(I.isBarType),
            M = I.getShapeIndices(I.isLineType), z = I.hasArcType(), H = I.filterTargetsToShow(I.data.targets),
            B = I.xv.bind(I);
        ...
        n.prototype._isCurrentSpace = function () {
            ...
            if (this._skipOptionalSpaces(), this._currentIndex < this._endIndex && "+" == this._string.charAt(this._currentIndex) ? this._currentIndex++ : this._currentIndex < this._endIndex && "-" == this._string.charAt(this._currentIndex) && (this._currentIndex++, a = -1), !(this._currentIndex == this._endIndex || (this._string.charAt(this._currentIndex) < "0" || this._string.charAt(this._currentIndex) > "9") && "." != this._string.charAt(this._currentIndex))) {
                ...
                if (this._currentIndex != s) for (var c = this._currentIndex - 1, d = 1; c >= s;) e += d * (this._string.charAt(c--) - "0"), d *= 10;
                if (this._currentIndex < this._endIndex && "." == this._string.charAt(this._currentIndex)) {
                    ...
                    for (; this._currentIndex < this._endIndex && this._string.charAt(this._currentIndex) >= "0" && this._string.charAt(this._currentIndex) <= "9";) i *= 10, n += (this._string.charAt(this._currentIndex) - "0") / i, this._currentIndex += 1
                }
        ...
        if (!arguments.length) return {x: i.axis_x_max, y: i.axis_y_max, y2: i.axis_y2_max};
        ...
        var e = this.internal, i = e.config;
        if (!arguments.length) return {x: i.axis_x_min, y: i.axis_y_min, y2: i.axis_y2_min};
        ...
        var e, i, n, a, r, o, s, c = this.internal, d = [], u = c.getMaxDataCount(), h = 0, g = 0;
        ...
        e = c.convertDataToTargets(i, !0), c.data.targets.forEach(function (t) {
            ...
            for (i = 0; i < e.length; i++) if (t.id === e[i].id) {
                for (a = !0, t.values[t.values.length - 1] && (g = t.values[t.values.length - 1].index + 1), h = e[i].values.length, n = 0; n < h; n++) e[i].values[n].index = g + n, c.isTimeSeries() || (e[i].values[n].x = g + n);
            ...
            var e, i;
            for (e = 0; e < d.length; e++) if (t.id === d[e]) for (g = t.values[t.values.length - 1].index + 1, i = 0; i < h; i++) t.values.push({
                id: t.id,
                index: g + i,
        ...
        return function () {
            var a, o, s, c = t.targets, d = t.flow, l = t.drawBar, u = t.drawLine, h = t.drawArea, g = t.cx, f = t.cy,
                p = t.xv, _ = t.xForText, x = t.yForText, y = t.duration, S = 1, w = d.index, v = d.length,
                b = e.getValueOnIndex(e.data.targets[0].values, w),
                T = e.getValueOnIndex(e.data.targets[0].values, w + v), A = e.x.domain(), P = d.duration || y,
                C = d.done || function () {
                }, L = e.generateWait(), V = e.xgrid || n.selectAll([]), G = e.xgridLines || n.selectAll([]),
                E = e.mainRegion || n.selectAll([]), O = e.mainText || n.selectAll([]),
                I = e.mainBar || n.selectAll([]), R = e.mainLine || n.selectAll([]), k = e.mainArea || n.selectAll([]),
            ...
            e.flowing = !0, e.data.targets.forEach(function (t) {
                ...
                var t, n = [], a = [], o = [];
                if (v) {
                    for (t = 0; t < v; t++) n.push("." + r.shape + "-" + (w + t)), a.push("." + r.text + "-" + (w + t)), o.push("." + r.eventRect + "-" + (w + t));
        ...
        var e, i, n, a = this.internal, o = a.config;
        ...
        var n = this.internal, a = n.d3, o = n.config;
        o.data_selection_enabled && n.main.selectAll("." + r.shapes).selectAll("." + r.shape).each(function (s, c) {
            var d = a.select(this), l = s.data ? s.data.id : s.id, u = n.getToggle(this, s).bind(n),
                h = o.data_selection_grouped || !t || t.indexOf(l) >= 0, g = !e || e.indexOf(c) >= 0,
        ...
        a.data_selection_enabled && i.main.selectAll("." + r.shapes).selectAll("." + r.shape).each(function (o, s) {
            var c = n.select(this), d = o.data ? o.data.id : o.id, l = i.getToggle(this, o).bind(i),
                u = a.data_selection_grouped || !t || t.indexOf(d) >= 0, h = !e || e.indexOf(s) >= 0,
        ...
        var e, i = this, n = i.main, a = i.classChartArc.bind(i), o = i.classArcs.bind(i), s = i.classFocus.bind(i);
        ...
        var n, a = this, o = a.d3, s = a.config, c = a.main;
        ...
        var e = this, i = e.config.data_classes[t], n = "";
        ...
        var t = this, e = t.config, i = t.d3, n = e.data_colors,
            a = S(e.color_pattern) ? e.color_pattern : i.scale.category10().range(), r = e.data_color, o = [];
        return function (t) {
        ...
        var t = this.config, e = t.color_pattern, i = t.color_threshold, n = "value" === i.unit,
            a = i.values && i.values.length ? i.values : [], r = i.max || 100;
        ...
        return r.forEach(function (i) {
            ...
            return {
                id: r, id_org: e, values: t.map(function (t, o) {
        ...
        var i = this, n = i.config, a = n.axis_rotated ? 1 : 0, r = n.axis_rotated ? 0 : 1, o = i.circleY(t, t.index),
            s = i.x(t.x);
        ...
        return i[0] = {x: i[0].x - 1, value: i[0].value, id: i[0].id}, i[t.length + 1] = {
            x: i[t.length].x + 1,
        ...
        if (c.data_groups.length > 0) for (o = s.hasNegativeValueInTargets(t), e = 0; e < c.data_groups.length; e++) if (0 !== (a = c.data_groups[e].filter(function (t) {
        ...
        var e, i, n, a, r, o, s = this, c = s.config, d = s.mapToIds(t), l = s.getValuesAsIdKeyed(t);
        if (c.data_groups.length > 0) for (o = s.hasPositiveValueInTargets(t), e = 0; e < c.data_groups.length; e++) if (0 !== (a = c.data_groups[e].filter(function (t) {
            return d.indexOf(t) >= 0
        })).length) for (n = a[0], o && l[n] && l[n].forEach(function (t, e) {
            l[n][e] = t > 0 ? t : 0
        }), i = 1; i < a.length; i++) r = a[i], l[r] && l[r].forEach(function (t, e) {
        ...
        var n, a, r, o, s, c, d, u, h, g, f = this, p = f.config, _ = t.filter(function (t) {
                return f.axis.getId(t.id) === e
            }), x = i ? f.filterByXDomain(_, i) : _, y = "y2" === e ? p.axis_y2_min : p.axis_y_min,
            w = "y2" === e ? p.axis_y2_max : p.axis_y_max, v = f.getYDomainMin(x), b = f.getYDomainMax(x),
            T = "y2" === e ? p.axis_y2_center : p.axis_y_center,
            A = f.hasType("bar", x) && p.bar_zerobased || f.hasType("area", x) && p.area_zerobased,
            P = "y2" === e ? p.axis_y2_inverted : p.axis_y_inverted, C = f.hasDataLabel() && p.axis_rotated,
        ...
        var e, i, n, a, r = this, s = r.config, c = t[1] - t[0];
        ...
        var e = this, i = [e.getXDomainMin(t), e.getXDomainMax(t)], n = i[0], a = i[1], r = e.getXDomainPadding(i),
            o = 0, s = 0;
        ...
        var e, i, n, a, o, s, c, d, l = this, u = l.config, h = l.main, g = l.d3;
        l.hasArcType() || u.data_selection_enabled && (u.zoom_enabled && !l.zoom.altDomain || u.data_selection_multiple && (e = l.dragStart[0], i = l.dragStart[1], n = t[0], a = t[1], o = Math.min(e, n), s = Math.max(e, n), c = u.data_selection_grouped ? l.margin.top : Math.min(i, a), d = u.data_selection_grouped ? l.height : Math.max(i, a), h.select("." + r.dragarea).attr("x", o).attr("y", c).attr("width", s - o).attr("height", d - c), h.selectAll("." + r.shapes).selectAll("." + r.shape).filter(function (t) {
            ...
            var i, n, a, u, h, f, p = g.select(this), _ = p.classed(r.SELECTED), x = p.classed(r.INCLUDED), m = !1;
        ...
        var e = this, i = t && !e.hasType("gauge") ? e.defaultArcValueFormat : e.yFormat,
        ...
        var e = this, i = e.config, n = e.d3, a = e.generateGridData(i.grid_x_type, e.x),
        ...
        var e, i, n, a = this, o = a.main, s = a.config;
        ...
        var e = this, i = e.config, n = t.filter(function (t) {
            return t && l(t.value)
        }), a = e.main.selectAll("line." + r.xgridFocus), o = e.xx.bind(e);
        ...
        var i, n, a, o, s = this, c = [], d = s.main.select("." + r.axisX).selectAll(".tick").size();
        if ("year" === t) for (n = (i = s.getXDomain())[0].getFullYear(), a = i[1].getFullYear(), o = n; o <= a; o++) c.push(new Date(o + "-01-01 00:00:00")); else (c = e.ticks(10)).length > d && (c = c.filter(function (t) {
            return ("" + t).indexOf(".") < 0
        }));
        return c
        ...
        var i = this, n = i.config, a = i.getGridFilterToRemove(t), o = function (t) {
            return !a(t)
        }, s = e ? r.xgridLines : r.ygridLines, c = e ? r.xgridLine : r.ygridLine;
        ...
        var t, e, i = this, n = i.config, a = i.isMultipleX(),
        ...
        t = t || s.eventRect.data(function (t) {
            return t
        }), s.isMultipleX() ? (e = 0, i = 0, n = s.width, a = s.height) : (!s.isCustomX() && !s.isTimeSeries() || s.isCategorized() ? (r = s.getEventRectWidth(), o = function (t) {
            return s.x(t.x) - r / 2
        ...
        t.append("rect").attr("class", e.classEvent.bind(e)).style("cursor", n.data_selection_enabled && n.data_selection_grouped ? "pointer" : null).on("mouseover", function (t) {
            ...
            var a, o = t.index, s = e.svg.select("." + r.eventRect + "-" + o);
        ...
        t.append("rect").attr("x", 0).attr("y", 0).attr("width", i.width).attr("height", i.height).attr("class", r.eventRect).on("mouseout", function () {
            ...
            var t, o, s, c = i.filterTargetsToShow(i.data.targets);
            ...
            var t, e, o = i.filterTargetsToShow(i.data.targets);
        ...
        var n = this, a = "." + r.eventRect + (n.isMultipleX() ? "" : "-" + e), o = n.main.select(a).node(),
            s = o.getBoundingClientRect(), c = s.left + (i ? i[0] : 0), d = s.top + (i ? i[1] : 0),
        ...
        function a(e, i, a) {
            ...
            var o, s, c = 0 === a, d = a === t.length - 1, l = n(e, i),
                u = l.width + G + (!d || b.isLegendRight || b.isLegendInset ? P : 0) + T.legend_padding,
                h = l.height + A, g = b.isLegendRight || b.isLegendInset ? h : u,
        ...
        var o, s, c, d, l, u, h, g, f, p, _, x, m, y, S, v, b = this, T = b.config, A = 4, P = 10, C = 0, L = 0, V = 10,
            G = T.legend_item_tile_width + 5, E = 0, O = {}, I = {}, R = {}, k = [0], D = {}, F = 0;
        t = t.filter(function (t) {
            return !(void 0 !== T.data_names[t]) || null !== T.data_names[t]
        }), _ = w(e = e || {}, "withTransition", !0), x = w(e, "withTransitionForTransform", !0), b.isLegendInset && (F = T.legend_inset_step ? T.legend_inset_step : t.length, b.updateLegendStep(F)), b.isLegendRight ? (o = function (t) {
            return C * D[t]
        }, d = function (t) {
            return k[D[t]] + O[t]
        }) : b.isLegendInset ? (o = function (t) {
            return C * D[t] + 10
        }, d = function (t) {
            return k[D[t]] + O[t]
        }) : (o = function (t) {
        ...
        var n = this, a = n.config, o = (a.axis_rotated ? n.circleY : n.circleX).bind(n),
            s = (a.axis_rotated ? n.circleX : n.circleY).bind(n), c = n.pointSelectR.bind(n);
        ...
        var i, n = this;
        return "circle" === t.nodeName ? i = n.isStepType(e) ? function () {
        } : n.togglePoint : "path" === t.nodeName && (i = n.togglePath), i
    },C.toggleShape = function (t, e, i) {
        var n = this, a = n.d3, o = n.config, s = a.select(t), c = s.classed(r.SELECTED), d = n.getToggle(t, e).bind(n);
        ...
        var e = this, i = e.config, n = e.classChartBar.bind(e), a = e.classBars.bind(e), o = e.classFocus.bind(e);
        ...
        var e = this, i = e.barData.bind(e), n = e.classBar.bind(e), a = e.initialOpacity.bind(e), o = function (t) {
            return e.color(t.id)
        };
        ...
        var i = this, n = e ? i.subXAxis : i.xAxis, a = t.__max__ + 1, r = i.getBarW(n, a),
            o = i.getShapeX(r, a, t, !!e), s = i.getShapeY(!!e), c = i.getShapeOffset(i.isBarType, t, !!e),
            d = r * (i.config.bar_space / 2), l = e ? i.getSubYScale : i.getYScale;
        return function (t, e) {
        ...
        var e = this.d3.mouse(t), i = t.getBoundingClientRect(), n = t.pathSegList.getItem(0),
            a = t.pathSegList.getItem(1), r = Math.min(n.x, a.x), o = Math.min(n.y, a.y), s = r + i.width + 2,
            c = o + i.height + 2, d = o - 2;
        ...
        var e, i = this, n = i.config, a = i.classChartLine.bind(i), o = i.classLines.bind(i), s = i.classAreas.bind(i),
            c = i.classCircles.bind(i), d = i.classFocus.bind(i);
        ...
        var i = this, n = i.config, a = i.d3.svg.line(), r = i.generateGetLinePoints(t, e),
            o = e ? i.getSubYScale : i.getYScale, s = function (t) {
        ...
        return a = n.axis_rotated ? a.x(c).y(s) : a.x(s).y(c), n.line_connectNull || (a = a.defined(function (t) {
            ...
            var r, s = n.line_connectNull ? i.filterRemoveNull(t.values) : t.values, c = e ? i.x : i.subX,
                d = o.call(i, t.id), l = 0, u = 0;
        ...
        var i = this, n = i.config, a = t.__max__ + 1, r = i.getShapeX(0, a, t, !!e), o = i.getShapeY(!!e),
            s = i.getShapeOffset(i.isLineType, t, !!e), c = e ? i.getSubYScale : i.getYScale;
        return function (t, e) {
        ...
        var r, o, s, c, d, l, u, h, g, f, p, _ = this, x = _.config, m = "M", y = _.isCategorized() ? .5 : 0, S = [];
        if (void 0 !== n) for (r = 0; r < n.length; r++) S[r] = {}, void 0 === n[r].start ? S[r].start = t[0].x : S[r].start = _.isTimeSeries() ? _.parseDate(n[r].start) : n[r].start, void 0 === n[r].end ? S[r].end = t[t.length - 1].x : S[r].end = _.isTimeSeries() ? _.parseDate(n[r].end) : n[r].end;
        for (f = x.axis_rotated ? function (t) {
            ...
            var s, c = t.x.getTime(), l = n.x - t.x, u = new Date(c + l * r), h = new Date(c + l * (r + o));
            ...
            if (void 0 !== S && function (t, e) {
                ...
                return !1
            }(t[r].x, S)) for (c = _.getScale(t[r - 1].x + y, t[r].x + y, _.isTimeSeries()), d = _.getScale(t[r - 1].value, t[r].value), l = e(t[r].x) - e(t[r - 1].x), u = i(t[r].value) - i(t[r - 1].value), g = 2 * (h = 2 / Math.sqrt(Math.pow(l, 2) + Math.pow(u, 2))), o = h; o <= 1; o += g) m += s(t[r - 1], t[r], o, h); else m += " " + f(t[r]) + " " + p(t[r]);
            t[r].x
        }
        return m
        ...
        var i = this, n = i.config, a = i.d3.svg.area(), r = i.generateGetAreaPoints(t, e),
            o = e ? i.getSubYScale : i.getYScale, s = function (t) {
                return (e ? i.subxx : i.xx).call(i, t)
            }, c = function (t, e) {
        ...
        return a = n.axis_rotated ? a.x0(c).x1(d).y(s) : a.x(s).y0(n.area_above ? 0 : c).y1(d), n.line_connectNull || (a = a.defined(function (t) {
            ...
            var e, r = n.line_connectNull ? i.filterRemoveNull(t.values) : t.values, o = 0, s = 0;
        ...
        var i = this, n = i.config, a = t.__max__ + 1, r = i.getShapeX(0, a, t, !!e), o = i.getShapeY(!!e),
            s = i.getShapeOffset(i.isAreaType, t, !!e), c = e ? i.getSubYScale : i.getYScale;
        return function (t, e) {
            var a = c.call(i, t.id)(0), d = s(t, e) || a, l = r(t), u = o(t);
        ...
        var t = this, e = t.config, i = l(e.padding_top) ? e.padding_top : 0;
        ...
        var e = this, i = e.config, n = i.axis_rotated || !i.axis_rotated && !i.axis_y_inner,
            a = i.axis_rotated ? r.axisX : r.axisY, o = e.main.select("." + a).node(),
            s = o && n ? o.getBoundingClientRect() : {right: 0}, c = e.selectChart.node().getBoundingClientRect(),
            d = e.hasArcType(), l = s.right - c.left - (d ? 0 : e.getCurrentPaddingLeft(t));
        return l > 0 ? l : 0
        ...
        var t = this, e = t.config, i = t.context = t.svg.append("g").attr("transform", t.getTranslate("context")),
        ...
        var e, i = this, n = i.context, a = i.config, o = i.classChartBar.bind(i), s = i.classBars.bind(i),
            c = i.classChartLine.bind(i), d = i.classLines.bind(i), l = i.classAreas.bind(i);
        ...
        var n, a = this.d3.select("body").append("div").classed("c3", !0),
        ...
        var a = this, r = a.generateGetAreaPoints(t, !1), o = a.generateGetBarPoints(e, !1),
            s = a.generateGetLinePoints(i, !1), c = n ? a.getXForText : a.getYForText;
        return function (t, e) {
        ...
        var a, r, o, s, c, d, l = this, u = l.config, h = u.tooltip_format_title || e,
            g = u.tooltip_format_name || function (t) {
                return t
            }, f = u.tooltip_format_value || i, p = this.getTooltipSortFunction();
        for (p && t.sort(p), r = 0; r < t.length; r++) if (t[r] && (t[r].value || 0 === t[r].value) && (a || (o = b(h ? h(t[r].x) : t[r].x), a = "<table class='" + l.CLASS.tooltip + "'>" + (o || 0 === o ? "<tr><th colspan='2'>" + o + "</th></tr>" : "")), void 0 !== (s = b(f(t[r].value, t[r].ratio, t[r].id, t[r].index, t))))) {
        ...
        var e = this.config, i = g(t) ? t : t.id;
        ...
        e.zoom = i.behavior.zoom().on("zoomstart", function () {
            ...
            var t = m(e.x.orgDomain()) / m(e.getZoomDomain()), i = this.orgScaleExtent();
